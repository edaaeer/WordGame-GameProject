...
public class WordsGrid : MonoBehaviour
{
                ...
                foreach (var squareLetter in squares.Row)
                {
                    ...
                    if(normalLetterData.image == null || selectedLetterData.image == null)
                    {
                        Debug.LogError("All fields in your array should have some letters. " +
                            "Press Fill up with random button in your board data to add random letter. Letter: "+ squareLetter);
                    ...
                    else
                    {
                        ...
                        _squareList[_squareList.Count - 1].GetComponent<GridSquare>().SetSprite(normalLetterData,
                            correctLetterData, selectedLetterData) ;
    ...
    private bool ShouldScaleDown(Vector3 targetScale)
    {
        ...
        squareSize.x = (squareRect.width + targetScale.x) + squareOffset; //* olabilir
        squareSize.y = (squareRect.height + targetScale.y) + squareOffset; //* olabilir
